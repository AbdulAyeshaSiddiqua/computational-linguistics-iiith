...
{
   var text ='{"con1":[' + 
       '{"a":"John ate an apple before afternoon <br>", "b":"before afternoon John ate an apple <br>", "c":"John before afternoon ate an apple"},' +
...
obj = JSON.parse(text);
document.getElementById("r1").innerHTML = obj.con1[0].a + "" + obj.con1[0].b + "" + obj.con1[0].c;
document.getElementById("r2").innerHTML = obj.con1[1].a + "" + obj.con1[1].b;
document.getElementById("r3").innerHTML = obj.con1[2].a + "" + obj.con1[2].b;
document.getElementById("r4").innerHTML = obj.con1[3].a + "" + obj.con1[3].b + "" + obj.con1[3].c;
document.getElementById("r5").innerHTML = obj.con1[4].a + "" + obj.con1[4].b;
document.getElementById("r6").innerHTML = obj.con1[5].a + "" + obj.con1[5].b + "" + obj.con1[5].c + "" + obj.con1[5].d;
document.getElementById("r7").innerHTML = obj.con1[6].a + "" + obj.con1[6].b;
document.getElementById("r8").innerHTML = obj.con1[7].a + "" + obj.con1[7].b;
document.getElementById("r9").innerHTML = obj.con1[8].a + "" + obj.con1[8].b + "" + obj.con1[8].c + "" + obj.con1[8].d + "" + obj.con1[8].e + "" + obj.con1[8].f + "" + obj.con1[8].g + "" + obj.con1[8].h;
document.getElementById("r10").innerHTML = obj.con1[9].a + "" + obj.con1[9].b + "" + obj.con1[9].c + "" + obj.con1[9].d + "" + obj.con1[9].e + "" + obj.con1[9].f;
...
obj = JSON.parse(hin);
document.getElementById("s1").innerHTML = obj.con2[0].a + "" + obj.con2[0].b + "" + obj.con2[0].c + "" + obj.con2[0].d;
document.getElementById("s2").innerHTML = obj.con2[1].a + "" + obj.con2[1].b + "" + obj.con2[1].c + "" + obj.con2[1].d;
document.getElementById("s3").innerHTML = obj.con2[2].a + "" + obj.con2[2].b + "" + obj.con2[2].c + "" + obj.con2[2].d + "" + obj.con2[2].e + "" + obj.con2[2].f + "" + obj.con2[2].g + "" + obj.con2[2].h + "" + obj.con2[2].i + "" + obj.con2[2].j + "" + obj.con2[2].k + "" + obj.con2[2].l;
document.getElementById("s4").innerHTML = obj.con2[3].a + "" + obj.con2[3].b + "" + obj.con2[3].c + "" + obj.con2[3].d + "" + obj.con2[3].e + "" + obj.con2[3].f;
document.getElementById("s5").innerHTML = obj.con2[4].a + "" + obj.con2[4].b + "" + obj.con2[4].c + "" + obj.con2[4].d + "" + obj.con2[4].e + "" + obj.con2[4].f + "" + obj.con2[4].g + "" + obj.con2[4].h;
document.getElementById("s6").innerHTML = obj.con2[5].a + "" + obj.con2[5].b + "" + obj.con2[5].c + "" + obj.con2[5].d;
document.getElementById("s7").innerHTML = obj.con2[6].a + "" + obj.con2[6].b + "" + obj.con2[6].c + "" + obj.con2[6].d + "" + obj.con2[6].e + "" + obj.con2[6].f + "" + obj.con2[6].g + "" + obj.con2[6].h; 
